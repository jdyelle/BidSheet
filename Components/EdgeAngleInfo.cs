...
{
    internal class EdgeAngleInfo : Common.Part
    {
        ...
        public EdgeAngleInfo(int RowID, Components.LaborTimes LaborTimings)
        {
            this.RowID = RowID;
        ...
        public Data.SpreadsheetRowsRow GetRow()
        {
            ...
            if (BoltType == Enums.BoltTypes.Standard) { _Row.StdBolt = _Bolts; }
